...
import { goBack, goToPage } from '../../routes/'
         ...
         <div class="inner">
            <form>
               ...
               <custom-input
                  ...
                  v-model:input-value="registerForm.confirm_password"
                  type="password"
                  use-for-password
                  :error-state="errorState.confirm_password"
                  @validate-input="validateInput('confirm_password')"
               />
               <custom-input
                  label="Nama"
                  v-model:input-value="registerForm.name"
               ...
               <custom-input
                  label="No telepon"
                  input-mode="numeric"
                  v-model:input-value="registerForm.phone_number"
