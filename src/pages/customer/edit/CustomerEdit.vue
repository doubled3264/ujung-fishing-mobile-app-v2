...
<template>
  <ion-page class="customer-edit-page">
    ...
    <ion-content>
      <div class="inner">
        <form>
          <custom-input label="Nama" v-model:input-value="customerEditForm.name" :error-state="errorState.name"
            @validate-input="validateInput('name')" />
          <custom-input label="No telepon" v-model:input-value="customerEditForm.phone_number" input-mode="numeric"
